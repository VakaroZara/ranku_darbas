...
<html>
	...
	<body style="margin:0px;">
		...
		<div class="gridas">
			...
			<form class="ivedimas" method="post" action="registracija.php">
				<?php include('klaidos.php'); ?>
				<div>
					<input type="text" name="username" value="<?php echo $username; ?>" placeholder="Prisijungimo vardas">
				</div>
				<div>
					<input type="email" name="email" value="<?php echo $email; ?>" placeholder="El. paštas">
				</div>
				<div>
				...
				<p>
					Jau esate narys? <a href="prisijungimas.php">Prisijungti</a>
				</p>
			</form>
		</div>
